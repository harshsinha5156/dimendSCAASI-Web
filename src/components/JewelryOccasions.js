...
const GetInspired = () => {
  ...
  const exploreItems = [
    { title: 'GOLD CHAINS', image: '/images/jewelry1.webp' },
    { title: 'EARRINGS', image: '/images/jewelry2.webp' },
    { title: 'BRACELETS', image: '/images/jewelry3.webp' },
    { title: 'NECKLACES & PENDANTS', image: '/images/jewelry4.webp' },
    { title: 'STUDS', image: '/images/jewelry5.webp' },
  ];
    ...
    <section className="w-full overflow-hidden py-6 md:py-12 mt-4 md:mt-8 font-['Arapey']">
      ...
      <div className="mb-6 md:mb-10 flex justify-center">
        <h2 className="font-['Arapey'] text-2xl md:text-3xl leading-[1.2] text-black text-center">
          <span className="block md:inline">JEWELRY FOR ALL</span>
          <span className="block md:inline md:ml-2">OCCASIONS</span>
        </h2>
      </div>
