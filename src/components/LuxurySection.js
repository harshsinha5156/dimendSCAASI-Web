    ...
    <div className="w-full">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/shopby-mobile.webp')",
          }}
        ></div>
        ...
        <div className="hidden md:flex relative text-center text-white px-6 sm:px-8 max-w-3xl w-full flex-col items-center justify-center">
          ...
          <button
            className="w-full sm:w-auto px-6 sm:px-8 md:px-10 py-4 sm:py-5 bg-white text-black border border-black 
            font-medium uppercase hover:bg-gray-200 transition text-sm sm:text-base md:text-lg"
          >
            SHOP WATCHES
          </button>
        </div>
      ...
      <section className="hidden md:flex w-full bg-[#121212] h-[90px] sm:h-[100px] md:h-[110px] items-center justify-center">
        <div className="max-w-6xl lg:max-w-7xl mx-auto w-full flex flex-wrap justify-center gap-4 px-4">
