...
export default function Sections() {
  ...
  <div className="container mx-auto flex flex-col lg:flex-row items-center lg:items-stretch gap-16">
    
    {/* Left Part - 2 Images Side by Side (Desktop only >=1024px) */}
    <div className="hidden lg:grid w-full lg:w-[680px] h-[500px] grid-cols-2 gap-0">
      <img
    ...
    {/* Right Part - Content (Desktop only >=1024px) */}
    <div className="hidden lg:flex flex-1 items-center justify-center text-center lg:text-left px-6 lg:pl-12">
      <div>
        <p className="uppercase text-sm tracking-widest mb-2">
          From a dream to reality
        </p>
        <h2 className="text-3xl lg:text-4xl font-['Arapey'] mb-4">
          Made To Order
        </h2>
  ...
  {/* ---------- Mobile + Tablet Version (Accordion Overlay) ---------- */}
